...
# pihole-1 LXC (automatic for 06-host-overrides.conf via the sync script)
# scripts/sync-host-overrides.py --apply  pushes 06-host-overrides.conf
# directly to pihole-1 LXC (10000) and reloads pihole-FTL.
#
# 04-d-lcamaral-com.conf and 05-home.conf are NOT generated by the script
# (they're hand-curated zone files). Push those manually only when they
# change:
for f in 04-d-lcamaral-com.conf 05-home.conf; do
