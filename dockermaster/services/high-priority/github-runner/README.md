...
Self-hosted GitHub Actions runner for the home-lab-inventory repository. This service enables CI/CD workflows to execute
directly on the dockermaster server, providing access to local Docker services and deployment capabilities. The runner
is configured with Docker-in-Docker support for building and deploying containerized applications.
...
_Service Status: Active and Healthy_
